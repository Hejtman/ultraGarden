...
class Garden:
    ...
    def __init__(self):
        ...
        self.fogging_cycle = (RelaySet(set=(fan.off,  fog.off,  pump.off), delay=58),)  # deliver fog
        self.watering_cycle = (RelaySet(set=(fan.off, fog.off, pump.on), delay=50),   # pump for a while
